...
# Plotting for LGA data
plot_lga <- ggplot(data_lga, aes(x = variable, y = value, fill = variable)) +
...
# Plotting for TT data
plot_tt <- ggplot(data_tt, aes(x = variable, y = value, fill = variable)) +
    geom_bar(stat = "identity", position = "identity", color = "white", fill = "#fe6e87") +
    geom_text(aes(label = scales::percent(value)), hjust = -0.2, size = 3) +
...
grid.arrange(plot_lga, plot_tt, ncol = 1)
```
